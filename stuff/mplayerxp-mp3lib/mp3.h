...
/* decoder level: */
extern void MP3_Init(int fakemono,unsigned accel,int (*audio_read)(char *buf,int size,float *pts),const char *param);
...
extern int MP3_DecodeFrame(unsigned char *hova,short single,float *pts);
