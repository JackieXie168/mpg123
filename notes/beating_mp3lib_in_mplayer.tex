...
OK, that one needs more like 56.5 seconds. So I call this a typo. 

Whatever, it's faster now and the problem wasn't that big on the K6-III+ to begin with. Strange, didn't Diego specifically say that libmpg123 was slow on his system? Well, My time ran out some time ago, so I'll give the current patch to the MPlayer folks and let them produce some numbers to verify whatever I did and will do.
\end{document}
